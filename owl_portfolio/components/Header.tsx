  ...
  return (
    ...
    >
      <div className="relative z-10">
        ...
        <div className="text-center flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12 py-8 md:py-16">
          <div className="order-2 md:order-1">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-header  backdrop-blur-md">
              We make your ideas real
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-primary mb-6 md:mb-8 max-w-2xl mx-auto px-4  backdrop-blur-md">
